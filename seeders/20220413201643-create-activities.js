...
module.exports = {
    up: async(queryInterface, Sequelize) => {
        await queryInterface.bulkInsert('Activities', [{
                ...
                Content: 'Con materiales que chicos traen de las escuelas, se los ayuda a terminar los deberes.',
                createdAt: new Date(),
                updatedAt: new Date()
            },
            {
            ...
            },
            {
                ...
                Content: 'Con ayuda de tutores se orienta a los chicos para poder seguir en los estudios.',
                createdAt: new Date(),
                updatedAt: new Date()
            }
        ]);
