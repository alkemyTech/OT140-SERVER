      ...
      await queryInterface.bulkInsert('Activities', [
        {
          ...
          Contents: 'Con materiales que chicos traen de las escuelas, se los ayuda a termianr los deberes.',
          createdAt: new Date,
          updatedAt: new Date
        },
        {
          ...
          Contents: 'Con materiales de los chicos y ayuda de los tutores se realizan las actividades',
          createdAt: new Date,
          updatedAt: new Date
        },
        {
          ...
          Contents: 'Con ayuda de tutores se los horienta a los chicos para poder seguir en los estudios.',
          createdAt: new Date,
          updatedAt: new Date
        }], {});
  },
